...
VALUES
    ...
    ('Historic Manor', 'Step back in time at our Historic Manor. This grand estate exudes charm and elegance, offering a unique experience for those who appreciate the beauty of the past. With a minimum capacity of 10 guests and a maximum capacity of 15, it is perfect for special occasions, events, or a luxurious retreat.', 3, 5, 2, 'CREATED', true, 'HOTEL', 'PERSON', 'Øster Voldgade 7', 'Copenhagen', 'Denmark', '1350', false),
    ...
    ('Urban Oasis Apartment', 'Discover an urban oasis in our stylish apartment. Centrally located, this modern space provides a peaceful retreat in the heart of the city. With a minimum capacity of 1 guest and a maximum capacity of 2, it is perfect for solo travelers or a cozy couple’s getaway.', 1, 2, 1, 'EDITED', true, 'APARTMENT', 'PERSON', 'Üllői út 4', ' Budapest', 'Hungary', '1091', false),
    ('Charming Vineyard Cottage', 'Escape to the countryside in our Charming Vineyard Cottage. Surrounded by vineyards and rolling hills, this quaint cottage offers a peaceful retreat for wine enthusiasts. With a minimum capacity of 4 guests and a maximum capacity of 6, it is an ideal getaway for a small group or family.', 4, 5, 2, 'CREATED', true, 'ROOM', 'PERSON', 'Üllői út 5', ' Budapest', 'Hungary', '1091', false),
    ...
    ('Mountain View Lodge', 'Experience the beauty of nature at our Mountain View Lodge. Surrounded by majestic peaks, this cozy lodge offers a warm and inviting atmosphere. With a minimum capacity of 8 guests and a maximum capacity of 12, it is an excellent choice for group retreats or family gatherings in the mountains.', 2, 2, 4, 'CREATED', true, 'ROOM', 'PERSON', 'Üllői út 7', ' Budapest', 'Hungary', '1091', false),
    ('Rustic Farmhouse Retreat', 'Escape to the countryside in our Rustic Farmhouse Retreat. This charming farmhouse, surrounded by rolling fields, offers a peaceful escape from the hustle and bustle. With a minimum capacity of 4 guests and a maximum capacity of 8, it is perfect for a family getaway or a quiet retreat with friends.', 4, 6, 4, 'CREATED', true, 'ROOM', 'PERSON', 'Üllői út 8', ' Budapest', 'Hungary', '1091', false),
    ('Elegant City Townhouse', 'Discover sophistication in our Elegant City Townhouse. Located in a historic district, this beautifully appointed townhouse offers a luxurious urban escape. With a minimum capacity of 4 guests and a maximum capacity of 6, it is perfect for a stylish city retreat with friends or family.', 4, 6, 3, 'CREATED', true, 'ROOM', 'PERSON', 'Üllői út 9', ' Budapest', 'Hungary', '1091', false),
    ('Oceanfront Paradise Villa', 'Experience the epitome of luxury at our Oceanfront Paradise Villa. This exclusive villa boasts breathtaking ocean views, private amenities, and impeccable design. With a minimum capacity of 8 guests and a maximum capacity of 12, it is an ideal choice for a lavish seaside retreat or special occasions.', 3, 4, 2, 'CREATED', true, 'APARTMENT', 'PERSON', 'Üllői út 10', ' Budapest', 'Hungary', '1091', false),
    ...
    ('Coastal Clifftop Cottage', 'Perched on a coastal cliff, our Clifftop Cottage offers unrivaled views of the ocean. This charming cottage provides a tranquil and romantic escape, ideal for couples seeking a secluded getaway. With a minimum capacity of 2 guests and a maximum capacity of 3, it is a perfect retreat for those desiring privacy and breathtaking scenery.', 2, 3, 4, true, true, 'ROOM', 'ROOM', 'Øster Voldgade 10', 'Copenhagen', 'Denmark', '1350', false),
    ...
    ('Urban Loft Living', 'Embrace city life in our Urban Loft Living space. Located in the heart of downtown, this modern loft offers stylish design, convenience, and easy access to the vibrant urban scene. With a minimum capacity of 2 guests and a maximum capacity of 4, it is perfect for urban explorers or a chic city retreat.', 2, 4, 2, 'EDITED', true, 'ROOM', 'PERSON', 'Øster Voldgade 1', 'Copenhagen', 'Denmark', '1350', false),
    ('Majestic Mountain Manor', 'Experience grandeur at our Majestic Mountain Manor. Perched high in the mountains, this elegant manor offers opulent interiors, breathtaking views, and a luxurious escape. With a minimum capacity of 10 guests and a maximum capacity of 15, it is an ideal choice for special occasions or an extravagant mountain retreat.', 1, 5, 3, 'EDITED', true, 'APARTMENT', 'ROOM', 'Øster Voldgade 2', 'Copenhagen', 'Denmark', '1350', false),
    ('Riverside Haven Cottage', 'Escape to a Riverside Haven in our charming cottage by the river. Surrounded by nature, this cozy retreat offers tranquility and a connection to the outdoors. With a minimum capacity of 4 guests and a maximum capacity of 6, it is perfect for a family getaway or a peaceful retreat with friends.', 3, 6, 2, 'EDITED', true, 'APARTMENT', 'ROOM', 'Øster Voldgade 3', 'Copenhagen', 'Denmark', '1350', false),
    ('Artisanal Village House', 'Discover the charm of village life in our Artisanal Village House. This rustic yet stylish house offers a unique blend of tradition and comfort. With a minimum capacity of 6 guests and a maximum capacity of 8, it is perfect for those seeking an authentic village experience.', 5, 6, 1, 'EDITED', true, 'HOTEL', 'ROOM', 'Øster Voldgade 13', 'Copenhagen', 'Denmark', '1350', false),
